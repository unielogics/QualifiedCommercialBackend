    ...
    for pb in playbooks:
        ...
        for r in rows:
            ...
            by_key[r.requirement_key] = ResolvedRequirement(
                ...
                default_owner_type=getattr(r, "default_owner_type", "human"),
                default_channels=list(getattr(r, "default_channels", []) or []) or None,
                default_cadence_hours=getattr(r, "default_cadence_hours", 48),
                link_url=getattr(r, "link_url", None),
                link_label=getattr(r, "link_label", None),
