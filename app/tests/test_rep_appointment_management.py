...
from app.dealer_os.router import _appointment_google_color, _can_manage_appointment_crm, router
...
def test_crm_management_includes_scoped_field_representatives() -> None:
    ...
    assert _can_manage_appointment_crm(SimpleNamespace(role=Role.FIELD_REP))
