...
@pytest.mark.asyncio
async def test_initial_link_uses_branded_client_name_and_selected_products(monkeypatch):
    captured = {}
    ...
    assert captured["payload"]["client_name"] == "Qualified Commercial - Capital OS"
